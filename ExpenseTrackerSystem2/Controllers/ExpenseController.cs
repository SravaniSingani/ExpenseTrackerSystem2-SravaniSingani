...
using ExpenseTrackerSystem2.Migrations;
...
namespace ExpenseTrackerSystem1.Controllers
{
    public class ExpenseController : Controller
    {
        ...
        static ExpenseController()
        {
            ...
            client.BaseAddress = new Uri("https://localhost:44384/api/ExpenseData/");
        ...
        ///  curl https://localhost:44384/api/ExpenseData/FindExpense/{id}
        /// </example>
        ...
        {
            string url = "https://localhost:44384/api/CardData/ListCards";
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        {
            string url = "https://localhost:44384/api/CategoryData/ListCategories";
            HttpResponseMessage response = client.GetAsync(url).Result;
