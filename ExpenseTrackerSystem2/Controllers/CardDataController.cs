...
namespace ExpenseTrackerSystem2.Controllers
{
    public class CardDataController : ApiController
    {
        ...
        /// CURL: curl https://localhost:44384/api/CardData/FindCard/2
        /// </example>
        ...
        /// CURL: curl -d @card.json -H "Content-Type:application/json" https://localhost:44384/api/CardData/UpdateCard/6
        /// </example>
        ...
        /// FORM Data: Card JSON Object
        /// CURL: curl -d @card.json -H "Content-Type:application/json" https://localhost:44384/api/CardData/AddCard
        /// </example>
        ...
        /// CURL: curl -d "" https://localhost:44384/api/CardData/DeleteCard/9
        /// </example>
