...
namespace ExpenseTrackerSystem2.Controllers
{
    public class CategoryDataController : ApiController
    {
        ...
        /// CURL: curl https://localhost:44384/api/CategoryData/ListCategories
        /// </example>
        ...
        /// CURL: curl https://localhost:44384/api/CategoryData/FindCategory/2
        /// </example>
        ...
        /// CURL:  curl -d @category.json -H "Content-Type:application/json" https://localhost:44384/api/CategoryData/UpdateCategory/1
        /// </example>
